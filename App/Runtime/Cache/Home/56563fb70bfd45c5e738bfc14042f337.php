...
<head>
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="/Public/Home/style/jqzoom.cs7s" type="text/css">
    ...
    <div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
            ...
            <?php }?>
					...
					<div class="cat">
						<h3><a href="<?php echo U('category',array('id'=>$v['id']))?>"><?php echo $v['cat_name']?></a> <b></b></h3>
						<div class="cat_detail">
                        <?php foreach($catedata as $v1){ if($v1['parent_id']==$v['id']){ ?>
							<dl class="dl_1st">
								<dt><a href="<?php echo U('category',array('id'=>$v1['id']))?>"><?php echo $v1['cat_name']?></a></dt>
								<dd>
                                    <?php foreach($catedata as $v2){ if($v2['parent_id']==$v1['id']){ ?>
									<a href="<?php echo U('category',array('id'=>$v2['id']))?>"><?php echo $v2['cat_name']?></a>	
                                    <?php } }?>
								</dd>
							</dl>
                            <?php }}?>
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="/Public/Home/images/preview_s1.jpg"></a>
								</li>
								<li>
