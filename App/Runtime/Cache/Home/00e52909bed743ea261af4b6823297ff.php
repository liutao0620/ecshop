			...
			<div class="guide_wrap">
				...
				<div class="hot none">
                    ...
                    <?php foreach($hotdata as $v){?>
						<li>
							<dl>
								<dt><a href="<?php echo U('detail',array('id'=>$v['id']))?>"><img src="/Public/Uploads/<?php echo $v['goods_thumb']?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('detail',array('id'=>$v['id']))?>"><?php echo $v['goods_name']?></a></dd>
