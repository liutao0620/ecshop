...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select none">
					<ul>
						<li class="cur">
							<input type="radio" name="address" checked="checked" /> 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555 
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="address"  /> 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
					...
					<form action="<?php echo U('Order/flow')?>" class="none" id="forms" name="address_form" method="post">
						<ul>
							<li>
				...
				<div class="delivery_select none">
					<table>
						...
						<tbody>
							<tr class="cur">	
								<td>
									<input type="radio" name="shipping_name" checked="checked" value="1"/>普通快递
								</td>
								<td>￥10.00</td>
							...
							<tr>
								...
								<td><input type="radio" name="shipping_name" value="2"/>特快专递</td>
								<td>￥40.00</td>
								<td>每张订单不满499.00元,运费40.00元, 订单4...</td>
							</tr>
							<tr>
								
								<td><input type="radio" name="shipping_name" value="3" />加急快递送货上门</td>
								<td>￥40.00</td>
								<td>每张订单不满499.00元,运费40.00元, 订单4...</td>
							</tr>
							<tr>

								<td><input type="radio" name="shipping_name" value="4" />平邮</td>
								<td>￥10.00</td>
								<td>每张订单不满499.00元,运费15.00元, 订单4...</td>
							</tr>
						</tbody>
			...
			<div class="pay">
				...
				<div class="pay_select none">
					<table> 
						<tr class="cur">
							<td class="col1"><input type="radio" name="pay_name" value="1"/>货到付款</td>
							<td class="col2">送货上门后再收款，支持现金、POS机刷卡、支票支付</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay_name" value='2'/>在线支付</td>
							<td class="col2">即时到帐，支持绝大数银行借记卡及部分银行信用卡</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay_name" value="3" />支付宝</td>
							<td class="col2">自提时付款，支持现金、POS刷卡、支票支付</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay_name" value="4"/>邮局汇款</td>
			...
			<div class="goods">
				...
				<table>
                    ...
                    <?php foreach($cartdata as $v){?>
						<tr>
							<td class="col1"><a href=""><img src="/Public/Uploads/<?php echo $v['info']['goods_thumb']?>" alt="" /></a>  <strong><a href=""><?php echo $v['info']['goods_name']?></a></strong></td>
							<td class="col2"> <?php echo $v['attrs']?> </td>
							<td class="col3">￥<?php echo $v['info']['shop_price']?></td>
							<td class="col4"><?php echo $v['goods_count'];?></td>
							<td class="col5"><span>￥<?php echo $v['goods_count']*$v['info']['shop_price']?></span></td>
						</tr>
					<?php }?>	
					</tbody>
					<tfoot>
		...
		<div class="fillin_ft">
			<a href="javascript:" onclick="addOrder()"><span>提交订单</span></a>
