...
<div class="main-div">
  <form action="/Admin/Category/add" method="post" name="theForm" enctype="multipart/form-data">
        ...
        <td>
          <select name="parent_id">
                ...
                <?php foreach($catedata as $v){?>
                             <option  value="<?php echo $v['id']?>"><?php echo str_repeat('-',$v['lev']*2).$v['cat_name']?></option>
                <?php }?>
          </select>
        </td>
      </tr>
