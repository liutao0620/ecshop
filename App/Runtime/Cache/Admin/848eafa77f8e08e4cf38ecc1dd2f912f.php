  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      ...
      <a href="#" target="_top" class="fix-submenu">退出</a>
        ...
        <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;"><img src="/Public/Admin/images/top_loader.gif" width="16" height="16" alt="正在处理您的请求/Public/Admin." style="vertical-align: middle" /> 正在处理您的请求/Public/Admin.</div>
  </div>
