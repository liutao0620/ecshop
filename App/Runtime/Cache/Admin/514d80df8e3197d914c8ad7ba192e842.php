...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell" style = 'padding-left="100"'>
            <img src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:13em" />
            <span><a href="#" ><?php echo $v['id'];?></a></span>
    </td>
    
    <td width="50%" align="center"><span></span><?php echo $v['type_name'];?></td>
